...
GHOSTS Security Playground is a terraform template creating a lab implementation of the [GHOSTS](https://cmu-sei.github.io/GHOSTS/) NPC User simulation framework.  Additionally, it builds some capabilities for an AD pentest lab or Detection Engineering.  GHOSTS Playground is customizable and builds the following resources hosted in AWS:
