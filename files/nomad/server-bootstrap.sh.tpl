...
sudo mkdir -p /ops/shared/config
sudo chmod 777 -R /ops

echo '${nomad_hcl}' | base64 --decode > /ops/shared/config/nomad.hcl
echo '${nomad_service}' | base64 --decode > /ops/shared/config/nomad.service
