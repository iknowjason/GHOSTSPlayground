{
  "IdEnabled": true,
  "IdUrl": "http://${ghosts_server}:5000/api/clientid",
  "IdFormat": "guestlocal",
  "IdFormatKey": "guestinfo.id",
  "IdFormatValue": "$formatkeyvalue$-$machinename$",
  ...
  "ClientResults": {
    "IsEnabled": true,
    "IsSecure": false,
    "PostUrl": "http://${ghosts_server}:5000/api/clientresults",
    "CycleSleep": 300000
  },
  "ClientUpdates": {
    "IsEnabled": true,
    "PostUrl": "http://${ghosts_server}:5000/api/clientupdates",
    "CycleSleep": 300000
  },
  "Survey": {
    "IsEnabled": false,
    ...
    "CycleSleepMinutes": 5,
    "OutputFormat": "indent",
    "PostUrl": "http://${ghosts_server}:5000/api/clientsurvey"
  },
  "Content": {
    "EmailsMax":  20,
    "EmailContent": "",
